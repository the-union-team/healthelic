...
const comparisonData: ComparisonRow[] = [
    {
        ...
        medicus: 'Interprets, reasons, and delivers context-aware, evidence-based recommendations',
    },
    {
        feature: 'User Experience',
        conventionalAI: 'Feels like chatting with a search engine',
        medicus: 'Feels like collaborating with a trusted medical assistant who knows your case',
    },
    {
        feature: 'Intelligence Model',
        conventionalAI: 'Static, prompt-based replies',
        medicus: 'Dynamic, agentic reasoning with adaptive learning and context retention',
    },
    {
        feature: 'Personalization',
        conventionalAI: 'Generic, guideline-only output',
        medicus: 'Tailored to user profile, medical history, and conversation context',
    },
    {
        feature: 'Integration',
        conventionalAI: 'Siloed, standalone systems',
        medicus: 'Seamlessly connects with EHRs, telehealth, and clinical workflows',
    },
    {
        feature: 'Actionability',
        conventionalAI: 'Ends at information',
        medicus: 'Automates next steps — documentation, scheduling, follow-ups, or escalation',
    },
    {
        feature: 'Trust & Oversight',
        conventionalAI: 'Limited transparency',
        medicus: 'Physician-guided validation and dual-AI fact-checking to eliminate hallucinations',
    },
    {
        feature: 'Compliance',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <div className="max-w-3xl mx-auto space-y-4 text-gray-700 text-base sm:text-lg leading-relaxed">
                        <p>
                            Most AI in healthcare was built to <span className="font-semibold">search and summarize</span>.
                        </p>
                        <p>
                            Medicus was built to <span className="font-semibold bg-gradient-to-r from-purple-400 via-purple-500 to-blue-500 bg-clip-text text-transparent">understand, reason, and act</span>.
                        </p>
                    </div>
                </div>
                    ...
                    {comparisonData.map((row, index) => (
                        ...
                        >
                            <div className="bg-gradient-to-r from-purple-50 to-blue-50 px-4 py-3 border-b border-gray-200">
                                <h3 className="font-bold text-gray-900 text-base">{row.feature}</h3>
                            </div>
                            <div className="p-4 space-y-4">
                                <div>
                                    ...
                                    <p className="text-gray-700 text-sm leading-relaxed">{row.conventionalAI}</p>
                                </div>
                                <div className="pt-3 border-t border-gray-200">
                                    ...
                                    <p className="text-gray-900 text-sm font-medium leading-relaxed">{row.medicus}</p>
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="text-center max-w-4xl mx-auto">
                    <p className="text-gray-700 text-lg sm:text-xl md:text-2xl leading-relaxed font-medium italic">
                        ...
                        {' '}— empowering both patients and physicians to make smarter, faster, and safer decisions.
                    </p>
                </div>
            </div>
        </section>
